...
public class dragUI : MonoBehaviour, IDragHandler, IBeginDragHandler, IEndDragHandler
{
    ...
    //this script created by: Gyanendu Shekhar
    ...
    private bool IsRectTransformInsideSreen(RectTransform rectTransform)
    {
        ...
        Rect rect = new Rect(-0.75f * Screen.width, -0.75f * Screen.height, Screen.width + 1.5f * Screen.width, Screen.height + 1.5f * Screen.height);
